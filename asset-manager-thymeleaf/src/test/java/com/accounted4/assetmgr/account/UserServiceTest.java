...
public class UserServiceTest {
	...
	@Mock
	private UserAccountRepository accountRepositoryMock;
...
//	}
	...
	public void shouldThrowExceptionWhenUserNotFound() {
		...
		when(accountRepositoryMock.findByFullyQualifiedAccountName("user@example.com")).thenReturn(null);
		// act
