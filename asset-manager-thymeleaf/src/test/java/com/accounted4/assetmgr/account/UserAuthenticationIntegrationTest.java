...
import com.accounted4.assetmgr.config.WebSecurityConfigurationAware;
...
public class UserAuthenticationIntegrationTest extends WebSecurityConfigurationAware {
    ...
    public void userAuthenticates() throws Exception {
        final String username = "guest@Public";
        ...
        mockMvc.perform(post("/authenticate").param("username", username).param("password", "a42day"))
