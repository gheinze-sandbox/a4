...
-- Processing File: .\core\switch_user_to_tia.sql;     
--------------------------- 
SET search_path=tia,public;

SET SESSION AUTHORIZATION 'tia';--------------------------- 
-- Processing File: .\core\audit.sql     
--------------------------- 
...
$body$;
--------------------------- 
-- Processing File: .\core\installation_support_tools.sql     
--------------------------- 
---------------
...
$comment$;--------------------------- 
-- Processing File: .\core\user_account\user_account.sql     
--------------------------- 
...
INSERT INTO user_account(name, encrypted_password, display_name, email)
    VALUES ('admin', pgcrypto.crypt( concat('admin', 'admin'), pgcrypto.gen_salt('bf')), 'Administrator', 'tia.admin@gheinze.com');
...
SELECT user_account_create(
      ...
      ,p_email        := 'tia.admin@gheinze.com'
      ,p_owner_user_account_id := admin.id
      ,p_audit_user_account_id := admin.id
      )
  FROM admin;
--------------------------- 
-- Processing File: .\core\user_account\user_role.sql     
--------------------------- 
...
$$ LANGUAGE SQL;
--------------------------- 
-- Processing File: .\core\user_account\user_delegate.sql     
--------------------------- 
...
$$ LANGUAGE SQL;
--------------------------- 
-- Processing File: .\core\party\party.sql     
--------------------------- 
CREATE TABLE party(
  display_name       VARCHAR(64)  NOT NULL
 ,notes              TEXT
...
--------------------------- 
-- Processing File: .\core\party\person.sql     
--------------------------- 
CREATE TABLE person(
...
--------------------------- 
-- Processing File: .\core\party\organization.sql     
--------------------------- 
...
-- Processing File: .\core\party\organization_contact.sql     
--------------------------- 
...
-- Processing File: .\core\party\address.sql     
--------------------------- 
...
--------------------------- 
-- Processing File: .\core\party\person_address_map.sql     
--------------------------- 
...
--------------------------- 
-- Processing File: .\core\party\phone.sql     
--------------------------- 
CREATE TABLE phone(
...
--------------------------- 
-- Processing File: .\core\party\person_phone_map.sql     
--------------------------- 
...
--------------------------- 
-- Processing File: .\core\party\email.sql     
--------------------------- 
CREATE TABLE email(
...
-- Processing File: .\core\party\person_email_map.sql     
--------------------------- 
